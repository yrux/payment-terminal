...
<v-select
    ...
    label="Reports To*"
    required
    v-model="reporting_user_id"
    :error-messages="errors.reporting_user_id"
></v-select>
</v-col>
  ...
  methods: {
    ...
    addbrand: async function () {
      ...
      if (this.$refs.form.validate()) {
        ...
        formdata.append("reporting_user_id", this.reporting_user_id);
        if(this.image){
        ...
        if(!res.status){
            ...
            if(res.data.reporting_user_id){
                this.errors.reporting_user_id = res.data.reporting_user_id
            }
            //errors here
        }else{
            //suuccess here
            this.$store.commit("setNotification", 'User Created');
