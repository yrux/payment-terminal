<template>
    <div>
      ...
      >
        ...
        <template v-slot:item.actions="{ item }">
          <v-btn color="warning" fab x-small dark @click="brieflink(item.id)">
          ...
          <v-btn
            ...
            x-small
            dark
            :to="{ name: 'auth.usersubmissions.view', params: { id: item.id } }"
          >
  ...
  export default {
    ...
    methods: {
      brieflink(id){
        var url = process.env.MIX_BASE_URL+'/brief-view/'+id
