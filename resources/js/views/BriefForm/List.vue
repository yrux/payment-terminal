      ...
      >
        ...
        <template v-slot:item.actions="{ item }">
          <v-btn
            ...
            x-small
            dark
            :to="{ name: 'auth.briefforms.assign', params: { id: item.id } }"
            v-if="permissions.indexOf('briefforms-edit') >= 0"
          >
          ...
          <v-btn
            ...
            x-small
            dark
            :to="{ name: 'auth.briefforms.edit', params: { id: item.id } }"
            v-if="permissions.indexOf('briefforms-edit') >= 0"
          >
            <v-icon>mdi-pencil-plus</v-icon>
          </v-btn>
          <v-btn color="error" v-if="permissions.indexOf('briefforms-delete') >= 0" fab x-small dark @click="deleteuser(item.id)">
