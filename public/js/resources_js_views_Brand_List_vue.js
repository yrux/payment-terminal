...
var itemtypeservice = new _services_auth_default__WEBPACK_IMPORTED_MODULE_2__["default"]('brands');
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_defineProperty({
  ...
  methods: {
    brieflink: function brieflink(item) {
                  ...
                  "v-btn",
                  {
                    ...
                    on: {
                      click: function ($event) {
                        return _vm.brieflink(item)
                      },
                    },
                  },
                  [_c("v-icon", [_vm._v("mdi-form-dropdown")])],
                  1
                ),
                _vm._v(" "),
                _vm.permissions.indexOf("brands-edit") >= 0
                  ? _c(
                      "v-btn",
                      {
                        attrs: {
                  ...
                  : _vm._e(),
                _vm._v(" "),
                _vm.permissions.indexOf("brands-delete") >= 0
                  ? _c(
                      "v-btn",
                      {
                        attrs: {
